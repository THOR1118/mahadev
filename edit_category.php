...
if(isset($_GET['edit_category']))
{
    ...
    $get_data = "SELECT * FROM `category` WHERE Category_ID='$edit_category_id'";
...
<body>
            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="form">
                    ...
                    <div class="form-details">
                        ...
                        <input type="text" name="cname"  value="<?php echo $category_name?>" placeholder="Product Name" >
                        <button name="submit">Update Category</button>
                        <button name="view_products" style="background-color:#5783db; color:white;">
                        <a style="color:white; text-decoration:none; background-color:#5783db;" href="view_category.php">Go Back</a></button>
                        </div>    
                    </div>  
                </div>
            </form>
            ...
            <!----------------------Edit category code PHP-------------------->
            <?php

            if(isset($_POST['submit']))
            {
                $category_edit_name=$_POST['cname'];


                // Checking for empty fields //
                if($category_edit_name=='')
                {
                ...
                else
                {
                        ...
                        $update_pr = "UPDATE `category` SET `Category_Name`='$category_edit_name' WHERE Category_ID='$edit_category_id'";
