            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="form">
                    ...
                    <div class="form-details">
                        ...
                        <!-- </div> -->
                        <br><button name="submit">Update Product</button>
                        <button name="view_products" style="background-color:#5783db; color:white;">
                        <a style="color:white; text-decoration:none; background-color:#5783db;" href="admin_disp_product.php">Go Back</a></button>
                        </div>    
                    </div>  
                </div>
            </form>
