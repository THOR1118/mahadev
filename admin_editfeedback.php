...
if(isset($_GET['edit_feedback']))
{
    ...
    $get_data = "SELECT * FROM `feedback` WHERE Email='$edit_id'";
...
<body>
            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="form">
                    ...
                    <div class="form-details">
                        ...
                        <input type="text" name="pprice"  value="<?php echo $email?>"placeholder="Product Price" >
                        <input type="text" name="pdes"  value="<?php echo $msg?>"placeholder="Product Description" >
                        <button name="submit">Update Feedback</button>
                        <button name="view_products" style="background-color:#5783db; color:white;">
                        <a style="color:white; text-decoration:none; background-color:#5783db;" href="admin_disp_userfeedback.php">Go Back</a></button>
                        </div>    
                    </div>  
                </div>
            </form>
            ...
            if(isset($_POST['submit']))
            {
                ...
                if($pr_edit_name=='' or $pr_edit_price=='' or $pr_edit_des=='')
                {
                ...
                else
                {
                        ...
                        $update_pr = "UPDATE `feedback` SET `UserName`='$pr_edit_name',`Email`='$pr_edit_price',`Message`='$pr_edit_des' WHERE Email='$edit_id' ";
