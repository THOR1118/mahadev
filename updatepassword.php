...
if (isset($_GET['email']) && isset($_GET['resettoken']))
{
    ...
    $date=date("Y-m-d");
    $query = "SELECT * FROM `user` WHERE `user`.`Email`='$_GET[email]' AND `resettoken` ='$_GET[resettoken]' AND `resetexpiretoken`='$date'";
...
if(isset($_POST['updatepassword']))
{
   ...
   $hash = password_hash($pass,PASSWORD_DEFAULT);
    $update="UPDATE user SET  Password = '$hash',resettoken = NULL, resetexpiretoken = NULL WHERE Email = '$_GET[email]'";
