...
<body>
    ...
    <!-- MAIN -->
        <main>
            <h1 class="title"><b>All Categories</b></h1>
            <div class="main">
            <table>
<tr>
    <th>Sr No</th>
        ...
        while($row=mysqli_fetch_assoc($res))
        {
           ...
           <tr>
               ...
               <td><?php echo $category_name?></td>
                <td><a href='admin_editcategory.php?edit_cat=<?php echo $category_id ?>'><i class='fa fa-edit' style='color:black; font-size:20px;'></i></a></td>
                <td><a onclick="return confirm('Are you sure you want to Delete <?php echo $category_name?> Category?')" href='admin_delcategory.php?delete_category=<?php echo $category_id ?>'><i class='fa fa-trash' style='font-size:20px; color:black;' aria-hidden='true'></i></a></td>
            </tr>
         <?php
         }?>
    </section>
