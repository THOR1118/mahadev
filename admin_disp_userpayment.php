...
<html lang="en">
<head>
<link rel="stylesheet" href="css/admin_disp_userpayment.css?v=<?php echo time();?>">  
    <meta charset="UTF-8">
...
<body>
    ...
    <!-- MAIN -->
        <main>
            <h1 class="title"><b>All User Payments</b></h1>
            <div class="main">
            <table>
<tr>
    <th>Order ID</th>
...
<?php
         ...
         while($row=mysqli_fetch_assoc($res))
         {
            ...
            <tr>
                ...
                <td><?php echo $cus_address,$cus_city,$cus_state,$cus_zip?></td>
