                                ...
                                <thead>
                                 ...
                                 <tbody>
                                     <?php 
                                         ...
                                         include 'connect.php';
                                        $sql = "SELECT * FROM `work_order` WHERE order_status = 0 AND worker_id='$workerid'";
                                     ...
                                     <tr>
                                        ...
                                        <td><?php echo $result['Customername']; ?></td>
                                         ...
                                         <td>
                                             <form action="accept.php?id=<?php echo $result['order_id']; ?>" method="POST">
                                                 <input type="hidden" name="appid" value="<?php echo $result['order_id']; ?>">
